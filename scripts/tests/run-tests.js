...
async function main() {
  ...
  if (global.StockSolutionMakerTests) {
    ...
    const milpSkips = 12; // Known number of MILP-dependent tests (includes calculateStockSolutions, Progressive-K, optimizeFormula, Multi-target, PeKacid, Si convergence)
